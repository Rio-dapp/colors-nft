...
contract ColorsContract is ERC721Enumerable, Ownable, SafeMath, SafeCast {
    ...
    function margeColors(
        ...
        require(iterationCount > 1, "iterationCount need minimum 2");
    ...
    function predictColorAfterMarge(
        ...
        uint256 mageResult = tryAdd(colorCode0, colorCode1);
    ...
    function mintRandomColor(uint32 iterationCount) public returns (uint32) {
        ...
        // Не удалось сгенерировать уникальный цвет
        // нужно прервать выполнение контракта
        assert(generationSeccsess == true);
