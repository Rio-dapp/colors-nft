...
contract('ColorsContract', (accounts) => {
    ...
    it('Mint 3 tokens', async () => {
        ...
        var callerAccount = accounts[0];
        var colorHex = [
                        await ColorsContractInstance.mintRandomColor(1,{from: callerAccount}).call(),
                        await ColorsContractInstance.mintRandomColor(10,{from: callerAccount}).call(),
                        await ColorsContractInstance.mintRandomColor(100,{from: callerAccount}).call(),
        ];
