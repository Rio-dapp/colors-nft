...
contract('ColorsContract', (accounts) => {
    ...
    it('Set Marge commision', async () => {
        ...
        var commisionSeted = await ColorsContractInstance.setROKSCommision(MargeCommision,
            {from: callerAccount})

        assert.equal(commisionSeted, MargeCommision, 'commision must be MargeCommision = ' +MargeCommision);
