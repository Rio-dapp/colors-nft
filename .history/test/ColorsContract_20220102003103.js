...
contract('ColorsContract', (accounts) => {
    ...
    it('[margeColors] Marge colors: 0 teration', async () => {
        const ColorsContractInstance = await ColorsContract.deployed();
        var callerAccount = accounts[0];
    ...
    it('[predictColorAfterMarge] view Second ', async () => {
        const ColorsContractInstance = await ColorsContract.deployed();
        var callerAccount = accounts[0];
        ...
        console.log("       [predictColorAfterMarge] view Second " + predictMarge.toNumber());
