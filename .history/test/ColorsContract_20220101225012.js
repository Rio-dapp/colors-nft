...
contract('ColorsContract', (accounts) => {
    ...
    it('Marge colors view predictColorAfterMarge', async () => {
        ...
        var predictMarge = await ColorsContractInstance.predictColorAfterMarge(16777215,16777214,1);
        assert.equal(16777214, predictMarge.toNumber(), 'balanceOf must be 4');
    });
    ...
    it('Ovner Mint colors', async () => {
        ...
        var mint = await ColorsContractInstance.mintColors([16777215,16777214], ["16777215 test1"],["16777214 test2"],{from: callerAccount});
        assert.equal(16777214, predictMarge.toNumber(), 'balanceOf must be 4');
    });
});