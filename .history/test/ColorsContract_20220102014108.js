...
contract('ColorsContract', (accounts) => {
    ...
    it('[setInfo] and [getInfo] than show result', async () => {
        ...
        //await RoksTokenInstance.allowance(callerAccount, ColorsContractInstance.address);
        await RoksTokenInstance.approve(ColorsContractInstance.address, commision);
